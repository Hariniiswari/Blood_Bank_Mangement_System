...
public:
    ...
    Home()
    {
        ...
        home_details << "=================================================================================" << endl;
        home_details << "Hi everyone..." << endl;
        home_details << "\tWe have arranged for a blood bank camp at 'THIAGARAJAR COLLEGE OF ENGINEERING' , MADURAI..." << endl;
        ...
        home_details << "Mail id : rhariniiswari@gmail.com" << endl;
        home_details << "CONTACT NO : 8903626199" << endl;
        home_details << "=================================================================================" << endl;
        home_details << "\n";
...
public:
    ...
    void get_details_donor()
    {
        ...
        cin >> user_id;
        /*donor.open("Donor user details.txt",ios::in);
        if(donor.is_open())
        {
            while(!donor.eof())
            {
                getline(donor,line);
                if(((offset1 = line.find(user_id, 0))) == string::npos)
                {
        ...
        while(n == 1)
        {
            ...
            else
            {
                ...
                {
                    cout << "Enter valid user name : " << flush;
                }
            }
        }
        }*/
    ...
    void get_details_acceptor()
    {
        ...
        if(acceptor.is_open())
        {
            while(!acceptor.eof())
            {
                ...
                if(((offset2 = line.find(user_id, 0))) == string::npos)
                {
                   cout<<"The username is already in use"<<endl;
                   cout<<"Enter another username"<<endl;
                   cin>>user_id;
...
{
public:
    void login(char u[],char p[],Donor_registration obj)
    {
        int i;
        for(i=0;i<count;i++)
        {
            if((strcmp(u,obj.user_id) == 0) && (strcmp(p,obj.password) == 0))
            {
                cout << "Name        : " << obj.name << endl;
                cout << "Blood group : " << obj.blood << endl;
                cout << "Age         : " << obj.age << endl;
                cout << "Phone no    : " << obj.phone << endl;
            }
        }
        cout << "\n" <<endl;
    }
...
public:
        ...
        {
            fstream d;
            d.open("Donor user details.txt",ios::in);
            if(d.is_open())
            {
                while(!d.eof())
                {
...
/*
        ...
        cout << "------------------------" << endl;
        cout << "1.Donor module 2.Acceptor module 3.Search blood 4.Exit" << endl;
...
int main()
{
    ...
    while(1)
    {
        ...
        switch(choice)
        {
            case 1: cout << "Home details:-" << endl;
                    h.display_home_details();
                    break;

            case 2: cout << "Enter the choice[1.Donor Registration 2.Acceptor Registration]" << endl;
                    cin >> ch;
            ...
            case 3: cout << "------------------------" << endl;
                    ...
                    else
                    {
                        ...
                        {
                            cout << "Enter valid user_id and password!!!" << endl;
                        */
                    }
                    }
            ...
            case 5: cout << "------------------------" << endl;
                    ...
                    do
                    {
                        ...
                        switch(ch)
                        {
                            ...
                            case 2: ad.get_donor_data();
                                    break;

                            case 3: ad.get_acceptor_details();
                                    break;

                            case 4: ad.search_blood_group();
                                    break;
                        }
                    }while(ch!=5);
                    break;
